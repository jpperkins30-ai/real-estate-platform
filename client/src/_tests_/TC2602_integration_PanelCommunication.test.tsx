// Test Case 2602: Verify PanelCommunication between different panels
// Test Case TC2602: Verify PanelCommunication between different panels
// Test Case TC999: Verify integration_PanelCommunication functionality
import React, { useEffect } from 'react';
import { render, screen, fireEvent, waitFor } from '@testing-library/react';
import { describe, it, expect, vi, beforeEach } from 'vitest';
import { PanelSyncProvider, usePanelSync } from "../context/PanelSyncContext";
import { getPanelContent, registerPanelContent } from "../services/panelContentRegistry";
