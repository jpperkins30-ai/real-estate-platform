...
#
# This script renames the server __tests__ directory to _tests_
# to match the client-side convention
...
Write-Host "Your test files are now in the '_tests_' directory to match the client structure." -ForegroundColor Green 