// src/routes/properties.direct.ts
...
// This directive disables the specific TypeScript error we're encountering
// @ts-ignore: express-route-return-type
...
// @ts-ignore
router.get('/stats/county', async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
// @ts-ignore
router.post('/', authenticateToken, propertyValidation, async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
// @ts-ignore
router.put('/:id', authenticateToken, propertyValidation, async (req: Request, res: Response, next: NextFunction) => {
  try {
    if (handleValidationErrors(req, res)) {
      return;
    }
