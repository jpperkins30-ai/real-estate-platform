...
describe('MultiFrameContainer', () => {
  ...
  it('TC201: Verify MultiFrameContainer renders with default layout', () => {
    render(
      <MultiFrameContainer 
  ...
  it('TC204: Verify MultiFrameContainer initializes with provided panels', () => {
  ...
  it('TC202: Verify MultiFrameContainer changes layout when selector is used', () => {
    render(
      <MultiFrameContainer 
        initialLayout="dual" 
        onLayoutChange={mockLayoutChange}
  ...
  it('TC203: Verify MultiFrameContainer notifies parent when layout changes', () => {
    render(
      <MultiFrameContainer 
        initialLayout="single" 
  ...
  it('TC205: Verify MultiFrameContainer renders with advanced layout when enabled', () => {
    render(
      <MultiFrameContainer 
        initialLayout="single" 
