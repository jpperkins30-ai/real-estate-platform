...
// Simple wrapper for async handlers that doesn't return responses
// This is the key to fixing the TypeScript issues
...
router.get('/stats/county', asyncHandler(async (req: Request, res: Response) => {
 ...
 *         description: Forbidden - Invalid token
 */
router.post('/', authenticateToken, propertyValidation, asyncHandler(async (req: Request, res: Response) => {
 ...
 *         description: Property not found
 */
router.put('/:id', authenticateToken, propertyValidation, asyncHandler(async (req: Request, res: Response) => {
  if (handleValidationErrors(req, res)) {
    return;
  }
