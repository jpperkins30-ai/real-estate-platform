...
import PropertySearchBox from '../src/components/inventory/PropertySearchBox';
import propertySearchService from '../src/services/propertySearch';

// Mock the propertySearch service
vi.mock('../src/services/propertySearch', () => ({
  default: {
